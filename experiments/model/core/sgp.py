...
class SGP(ApproximateGP):
    ...
    def set_raw_ell(self, new_raw_ell=0.0):
        self.covar_module.base_kernel.raw_lengthscale.data.copy_(new_raw_ell * torch.ones_like(self.ell))

    def set_raw_sf(self, new_raw_sf=0.0):
        self.covar_module.raw_outputscale.data.copy_(new_raw_sf * torch.ones_like(self.sf))
